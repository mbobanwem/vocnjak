...
2. Post-S8 Step 1 should likely be Observation correction analysis/proposal, because it is already marked HIGH carry-forward and preserves history trust.
...
- Next work after S8 closure should be selected from Post-S8 carry-forward, likely Observation correction analysis/proposal
