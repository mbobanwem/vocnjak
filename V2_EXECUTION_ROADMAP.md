...
8. **S8 Step 7b — Trap Advisory Source-Coverage Gap Map.** Required before Step 7 closure; documentation/tracking only.
   ...
   - Coverage map species and required next actions:
     ...
     - `peach` — Grapholita / fruit moth monitoring: future full pattern candidate; trap-vs-scouting ambiguity at source rows 1064/1228 tracked at `V2_DOMAIN_MODEL.md` §3.2.1a:716. Required next action: source-check bands + fruit-signal pattern.
     - `nectarine` — Grapholita / fruit moth monitoring: future full pattern candidate; trap-vs-scouting ambiguity at source row 1228 tracked at `V2_DOMAIN_MODEL.md` §3.2.1a:716. Required next action: source-check bands + fruit-signal pattern.
