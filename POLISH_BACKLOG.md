...
Status: projection-ledger / runtime-anchor rule is active in `CLAUDE.md` (`783bda5`); the automated read-only parity verifier tool is still pending (see `Canonical parity test/tool` above). Leading open Phase 1 reliability gap.
