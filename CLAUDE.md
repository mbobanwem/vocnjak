...
- Structured trap/scouting/symptom/stage capture, program attachment, Dnevnik monitoring evidence beyond free-standing notes, observation correction, and stage confirmation are later Slice 8 steps; stage confirmation depends on owner-approved minimal stage vocabulary.
...
- Runtime Slice 8 Step 1, Step 2, and Step 3 are complete; later S8 work must remain owner-approved and must preserve the Plant detail note-only boundary unless the owner explicitly opens the next step
