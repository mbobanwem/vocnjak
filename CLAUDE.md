...
- Runtime Slice 8 Step 1, Step 2, Step 3, Step 4a, Step 5a, Step 6, Step 7 minimal runtime, Step 7b context-only trap advisory runtime, and Step 7c bounded visual scouting runtime are complete; Full Runtime Slice 8 is not complete; later S8 runtime work must remain owner-approved and must preserve the Plant detail free-standing Observation boundary unless the owner explicitly opens the next step
...
- Step 7b tracking / clarification is pushed on main at `665d38b Track S8 Step 7 trap advisory coverage gaps` and `9996f1a Clarify S8 Step 7b advisory tracking`; Step 7c docs/runtime are pushed on main at `7e388c5` and `588e413`; any follow-up cleanup commit must remain tightly scoped and must not be pushed without owner approval
