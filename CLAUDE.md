...
- B2 remains required before Slice 8 and owns `monitoring_programs[]`, `awareness_definitions[]`, `stage_vocabulary{}`, `target_registry[]`, `symptom_registry[]`, Kalendar Praćenje, Pregled Praćenje, Plant detail monitoring, and observation capture / observation rows; Slice 7 must not rely on monitoring or awareness content until B2 lands
