...
- Monitoring/Praćenje remains product-critical and long-term belongs in Pregled and Kalendar, but Pregled/Kalendar monitoring integration remains deferred until timing/display semantics are owner-approved. Observation capture, Dnevnik evidence, and stage confirmation are later Slice 8 steps; stage confirmation depends on owner-approved minimal stage vocabulary. Next work is S8 next-step planning or the next owner-approved S8 step.
