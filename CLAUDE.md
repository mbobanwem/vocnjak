...
- Broad/general scouting registry, symptom registry, program attachment, Dnevnik monitoring evidence beyond free-standing trap/note/diary stage/scouting history, observation correction, and broader phenology-aware stage confirmation are later owner-approved Slice 8 work; broader stage confirmation depends on a separate owner-approved phenology vocabulary beyond the Step 5a diary list.
...
- Runtime Slice 8 Step 1, Step 2, Step 3, Step 4a, Step 5a, Step 6, Step 7 minimal runtime, Step 7b context-only trap advisory runtime, Step 7c bounded visual scouting runtime, and Step 7d source-backed scouting guidance runtime are complete; Full Runtime Slice 8 is not complete; later S8 runtime work must remain owner-approved and must preserve the Plant detail free-standing Observation boundary unless the owner explicitly opens the next step
