...
Step 7 minimal runtime (`905af41 Implement S8 Step 7 trap advisory display`, pushed on main) implements advisory display only for four source-backed S8-blocker rows:
