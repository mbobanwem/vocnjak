...
- Status: coverage gate context recorded; Step 7 numeric-band runtime, Step 7b context-only trap advisory runtime, Step 7c bounded visual scouting runtime, and Step 7d source-backed scouting guidance runtime are pushed on main.
- Purpose (dual):
