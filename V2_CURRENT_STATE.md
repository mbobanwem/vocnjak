...
1. Roadmap/doc consolidation — this checkpoint; docs only.
2. A2 — Default V2 / remove `#v2` gate. Normal/original URL should load V2 after the later owner-approved implementation; legacy must remain reachable without deleting legacy data.
