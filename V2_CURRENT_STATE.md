...
```text
Post-S8 Step 1 should likely be Observation correction analysis/proposal, because it is the HIGH carry-forward item and preserves history trust. Do not implement it until separately owner-approved.
```
