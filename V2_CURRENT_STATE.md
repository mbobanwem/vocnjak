...
| peach | Grapholita / fruit moth monitoring | future full pattern candidate; trap-vs-scouting ambiguity at source rows 1064 (peach) and 1228 (nectarine) tracked at `V2_DOMAIN_MODEL.md` §3.2.1a:716 | source-check bands + fruit-signal pattern |
| nectarine | Grapholita / fruit moth monitoring | future full pattern candidate; trap-vs-scouting ambiguity at source row 1228 tracked at `V2_DOMAIN_MODEL.md` §3.2.1a:716 | source-check bands + fruit-signal pattern |
